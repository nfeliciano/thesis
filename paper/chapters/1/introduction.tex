...
Computer science and software engineering education utilizes these e-learning tools in similar ways to other disciplines. However, work in these fields often involve a large amount of collaboration with others, such as being able to examine and understand a collaborator's work and build upon it. The tools provided educating students in those fields will then need to support such activities, so students could receive training in the skills related to collaboration such as communication and teamwork skills.
...
In an effort to promote GitHub to higher education, GitHub launched the GitHub Education Website - \url{https://education.github.com/} - in 2014.
