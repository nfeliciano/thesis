...
Before proceeding, I note that GitHub has their own set of recommendations for setting up an organization for the class \footnote\url{https://education.github.com/guide}. Their guide is useful for those looking for a step-by-step process. As discussed in a previous chapter, it can also be helpful to use these resources available to you - use GitHub support, look for other instructor experiences for guidance, discuss your own experiences in a blog or in spaces dedicated to the topic \footnote{\url{https://github.com/education/teachers/issues}}. These can serve towards others getting a more complete idea of how GitHub can be used in this fashion.

\textbf{Recommendation: Use GitHub}
When teaching a computer science or software engineering course where many students can benefit from the exposure to Git, GitHub, and its features. For these students, simply getting more experience using a tool they may use in their careers, as well as getting assignments, projects, and code onto their repository, could prove to be valuable when they are getting their careers started.
...
\todo{is this necessary? I don't know how to end the chapter..}
