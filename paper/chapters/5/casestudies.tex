...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of benefits of using GitHub for education from the student perspective.}\label{table:interviews:github_tutorial}
    \vspace{1pt}
    \begin{center}
...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of challenges to using GitHub for education from the student perspective.}\label{table:interviews:github_tutorial}
    \vspace{1pt}
    \begin{center}
        \begin{tabular}{ | m{3cm} | m{12cm} | }
            \hline
...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of student recommendations for instructors who wish to use GitHub for their courses.}\label{table:interviews:github_tutorial}
    \vspace{1pt}
    \begin{center}
        \begin{tabular}{ | m{3cm} | m{12cm} | }
            \hline
...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of comparisons between GitHub as a learning tool and LMSes students have used in UVic.}\label{table:interviews:github_tutorial}
    \vspace{1pt}
    \begin{center}
        \begin{tabular}{ | m{3cm} | m{12cm} | }
            \hline
