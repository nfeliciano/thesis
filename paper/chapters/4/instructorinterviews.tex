...
%do we even need this paragraph since all the information is on the table?
%In our phase two interviews, three of the five interviewees used GitHub for Computer Science or Software Engineering courses, and 2 interviewees used GitHub for Humanities courses. All of the interviewees used GitHub for at least two semesters (max. five semesters). The class sizes ranged between 10 students and 130 students per course, where all the courses were taught as a face-to-face course (no online courses).
...
We sent a follow-up survey to the interviewees to get their feedback on our interpretation of the interview findings. We also publicly broadcasted the survey using social media [footnote] and used snowball sampling to garner responses from additional educators we had not interviewed. 8 of the interview participants and an additional 7 new respondents completed the survey, for a total of 15 responses.
%\url{https://twitter.com/alexeyzagalsky/status/471053256718692352}

\subsection{Data Collection}
For the interviews, we emailed invitations to lecturers and professors that use or have used GitHub to support teaching or learning. Potential participants were recruited in several ways: by contacting blog authors who shared their experiences of using GitHub in the classroom; by posting an invitation on Twitter [footnote]; and through snowball sampling, where interviewees could suggest other colleagues.
%\url{https://twitter.com/alexeyzagalsky/status/465914075348619264}

The interviews lasted 20-60 minutes and were conducted face to face or with Skype. Audio was recorded and the interviewer took notes. The interviews were semi-structured based on 18 guiding questions (our interview form is available online [footnote]), and the interviewer could \textit{dig deeper} with additional questions as deemed appropriate. This supported the exploratory nature of our study and allowed us to examine interesting and unexpected insights.
%\url{https://drive.google.com/file/d/0B273SDwCaBm_Z3V1X1BtakpKVlk/edit?usp=sharing}

We also interviewed John Britton, an education liaison from GitHub (this interview form is also available online [footnote]). This interview provided us with GitHub's corporate take on the use of its tool in education.
%\url{https://drive.google.com/file/d/0B273SDwCaBm_Z2toY0hBUWVjZ3c/edit?usp=sharing}
...
%  \centering
%    \includegraphics[width=0.5\textwidth]{EduWorkflowLargeType}
...
Using GitHub as a submission platform was accomplished in one of two ways [footnote]. Some interviewees set up a base repository for the class and had each student fork it---everyone who forked the base repository could see all other forked repositories as well. This allowed students to cross-reference different solutions and encouraged student collaboration (e.g., by using PRs) and peer learning. \textit{``When you do a pull, you can see what the others in the seminar are doing. For example, a student wrote a python script, and others want to use it, so they can just grab it and use it.''}[P4]
%\url{https://education.github.com/guide\#4-set-up-the-repositories}
...
Many interviewees used GitHub to host and deliver course materials [P4, P5, P8, P9, P10, P11, P12, P13, P15], including syllabi, slides, notes, reading materials, exercises and homework. It was even used to host the actual course Website, making GitHub \textit{``a bulletin board.''}[P10] The basic mechanism to host course Websites is by using GitHub markdown files, or for more traditional Websites, by using GitHub Pages [footnote] which hosts the material directly from one's repository.
