...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of participants' motivations and benefits of using GitHub for teaching purposes.}\label{table:interviews:benefits}
    \vspace{1pt}
    \begin{center}
...
\begin{table}[h]
    \vspace{1pt}
        \caption{Summary of participants' challenges with using GitHub for teaching purposes.}\label{table:interviews:challenges}
    \vspace{1pt}
    \begin{center}
        \begin{tabular}{ | m{3cm} | m{12cm} | }
            \hline
