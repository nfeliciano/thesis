...
Furthermore, external restrictions and managing large numbers of students or projects was not a challenge for most respondents (9). On the other hand, several respondents mentioned that they struggled with privacy concerns (5). And finally, most of the respondents (9) would appreciate having access to a knowledge base of shared practices on how to use GitHub for education. \todo{You already stated this above...perhaps reprase/elaborate so it seems more meaningful?}
